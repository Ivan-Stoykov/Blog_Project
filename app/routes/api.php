...
Route::get('admin/authorPosts', [AdminController::class, 'showNumberPostsByAuthor'])->middleware('auth:sanctum');
Route::get('admin/byCategory/{category}', [AdminController::class, 'showByPostCategory'])->middleware('auth:sanctum');
Route::get('admin/byTag/{tag}', [AdminController::class, 'showByPostTag'])->middleware('auth:sanctum');
Route::get('admin/byAuthor/{author}', [AdminController::class, 'showByPostAuthor'])->middleware('auth:sanctum');
Route::get('admin/byPeriod/{period}', [AdminController::class, 'showByPostPublishedAt'])->middleware('auth:sanctum');
